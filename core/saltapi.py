...
if __name__ == '__main__':
    ...
    ret1 = obj.remote_execution('*', 'grains.item',('ip4_interfaces'))['study-zyl-node5']['ip4_interfaces']['eth0']
    # ret1 = obj.async_remote_execution('*', 'grains.item', ('os', 'id'))
